...
public static class Binding
{
    ...
    public static extern ValueRef BuildInvoke2(BuilderRef b, TypeRef Ty, ValueRef Fn, ValueRef[] Args, uint NumArgs,
        BasicBlockRef Then, BasicBlockRef Catch, string Name);
    ...
    public static extern ValueRef BuildLandingPad(BuilderRef B, TypeRef Ty, ValueRef PersFn, uint NumClauses,
        string Name);
    ...
    public static extern ValueRef BuildCatchPad(BuilderRef B, ValueRef ParentPad, ValueRef[] Args, uint NumArgs,
        string Name);

    [DllImport("LLVM-C.dll", EntryPoint = "LLVMBuildCleanupPad")]
    public static extern ValueRef BuildCleanupPad(BuilderRef B, ValueRef ParentPad, ValueRef[] Args, uint NumArgs,
        string Name);

    [DllImport("LLVM-C.dll", EntryPoint = "LLVMBuildCatchSwitch")]
    public static extern ValueRef BuildCatchSwitch(BuilderRef B, ValueRef ParentPad, BasicBlockRef UnwindBB,
        uint NumHandlers, string Name);
    ...
    public static extern nint WriteBitcodeToFile(ModuleRef Module, string Path, out nint OutError);
    ...
    public static extern nint PrintModuleToFile(ModuleRef Module, string Path, out nint OutError);
    ...
    public static extern int VerifyModule(ModuleRef module, VerifierFailureAction Action, out nint OutMessage);
    ...
    public static extern ValueRef BuildCall2(BuilderRef builder, TypeRef ty, ValueRef function, ValueRef[] args,
        uint argnum, string name = "");

    [DllImport("LLVM-C.dll", EntryPoint = "LLVMGetVersion")]
    public static extern nint GetVersion();
    ...
    public static extern BoolRef CreateExecutionEngineForModule(out ExecutionEngineRef outee, ModuleRef m,
        out string error);
    ...
    [DllImport("LLVM-C.dll", EntryPoint = "LLVMBuildPointerCast")]
    public static extern ValueRef BuildPointerCast(BuilderRef Builder, ValueRef val, TypeRef DestTy, BoolRef signed,
        string name = "");
    ...
    public static extern BoolRef GetBitcodeModule2(MemoryBufferRef outMemBuf, out ModuleRef module);

    [DllImport("LLVM-C.dll", EntryPoint = "LLVMGetElementType", ExactSpelling = true)]
    public static extern TypeRef GetElementType(TypeRef val);

    [DllImport("LLVM-C.dll", EntryPoint = "LLVMCountParamTypes", ExactSpelling = true)]
    public static extern int CountParamTypes(TypeRef val);
    [DllImport("LLVM-C.dll", EntryPoint = "LLVMGetParamTypes", ExactSpelling = true)]
    public static extern void GetParamTypes(TypeRef val, out TypeRef[] args);
    [DllImport("LLVM-C.dll", EntryPoint = "LLVMPrintTypeToString", ExactSpelling = true)]
    public static extern string PrintTypeToString(TypeRef val);
